...
public class AdminOrderServiceTest {
	...
	public void testGetAllOrdersOfUser() throws Exception {
		...
		allOrdersOfUserList = aoservice.getAllOrdersOfUser("user4");
	...
	public void testGetAllOrdersOfAllUsers() throws Exception {
		...
		allOrdersOfAllUsersList = aoservice.getAllOrdersOfAllUsers("admin");
	...
	public void testGetDailySumTotal() throws Exception {
		...
		dailySumTotalList = aoservice.getDailySumTotal();
	...
	public void testGetMonthlySumTotal() throws Exception {
		...
		monthlySumTotalList = aoservice.getMonthlySumTotal();
	...
	public void testSearchOrder() throws Exception {
		...
		osvo.setBeginningDate("2019-06-01");
		osvo.setEndDate("2019-06-30");
		osvo.setAdvancedSearch("payerId");
		osvo.setUserQuery("user5");
		
		orderSearchList = aoservice.searchOrder(osvo);
	...
	public void testGenerateTrackingNumber() throws Exception {
		...
		// 중복되지 않는 운송장 번호생성
		String trackingNumber = aoservice.generateUniqueTrackingNumber();
