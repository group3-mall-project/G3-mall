...
//	 List<Ad_ProductViewVO> list = null; 
//	 list = service.listPageSearch2(displayPost,postNum, searchType, keyword);
	 
	 List<Ad_ProductViewVO> list = service.listPageSearch2(displayPost,postNum, searchType, keyword);
