...
public class AdminOrderController {
	...
	public void outputOrderDetailGET(String o_d_num, String backDest, String u_id, Model model, Integer currentPageNum) throws Exception {
		System.out.println("Presentation(Controller): outputOrderDetailGET(String o_d_num, String backDest, String u_id, Model model, Integer currentPageNum) 호출\n");
		...
		System.out.println("Presentation(Controller): outputOrderDetailGET(String o_d_num, String backDest, String u_id, Model model, Integer currentPageNum) 완료\n");	
	}
	// 주문 상세정보
	...
	public void editOrderDetailGET(String o_d_num, String backDest, String u_id, Model model, Integer currentPageNum) throws Exception {
		System.out.println("Presentation(Controller): editOrderDetailGET(String o_d_num, String backDest, String u_id, Model model, Integer currentPageNum) 호출\n");
		...
		System.out.println("Presentation(Controller): editOrderDetailGET(String o_d_num, String backDest, String u_id, Model model, Integer currentPageNum) 완료\n");		
	}

	
	@RequestMapping(value="/orderDetailEdit", method=RequestMethod.POST)
	public String editOrderDetailPOST(String o_d_num, String backDest, String u_id, Integer currentPageNum, RedirectAttributes redir, OrderVO ovo) throws Exception {
		System.out.println("Presentation(Controller): editOrderDetailPOST(String o_d_num, String backDest, String u_id, Integer currentPageNum, RedirectAttributes redir, OrderVO ovo) 호출\n");
		...
		System.out.println("Presentation(Controller): editOrderDetailPOST(String o_d_num, String backDest, String u_id, Integer currentPageNum, RedirectAttributes redir, OrderVO ovo) 완료\n");	
	...
	public String cancelOrderPOST(String o_d_num, String backDest, String u_id, Integer currentPageNum, RedirectAttributes redir) throws Exception {
		System.out.println("Presentation(Controller): cancelOrderPOST(String o_d_num, String backDest, String u_id, Integer currentPageNum, RedirectAttributes redir) 호출\n");
		...
		System.out.println("Presentation(Controller): cancelOrderPOST(String o_d_num, String backDest, String u_id, Integer currentPageNum, RedirectAttributes redir) 완료\n");		
